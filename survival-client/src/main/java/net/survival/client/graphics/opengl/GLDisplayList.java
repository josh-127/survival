...
public class GLDisplayList implements GraphicsResource
{
    ...
    public static class Builder
    {
        ...
        public Builder pushQuadAlongX(float y1, float z1, float y2, float z2, float x,
                boolean useNegativeXDirection, float u1, float v1, float u2, float v2)
        {
        ...
        public Builder pushQuadAlongY(float x1, float z1, float x2, float z2, float y,
                boolean useNegativeYDirection, float u1, float v1, float u2, float v2)
        {
        ...
        public Builder pushQuadAlongZ(float x1, float y1, float x2, float y2, float z,
                boolean useNegativeZDirection, float u1, float v1, float u2, float v2)
        {
            boolean shouldFlipX = x1 > x2;
            boolean shouldFlipY = y1 > y2;
