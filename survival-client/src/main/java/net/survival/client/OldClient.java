...
public class OldClient implements AutoCloseable {
    ...
    private OldClient(ColumnDbPipe.ClientSide columnPipe) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        var program = new OldClient(columnDbPipe.getClientSide());
